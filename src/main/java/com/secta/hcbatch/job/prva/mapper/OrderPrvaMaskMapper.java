package com.secta.hcbatch.job.prva.mapper;
...
public interface OrderPrvaMaskMapper {
     ...
     */
    List<OrderMaskTargetDto> selectOrderFnshList(@Param("day") String day);

    /**
     * 미결재 취소건 주문 목록 조회
     */
    List<OrderMaskTargetDto> selectOrderCnclList(@Param("day") String day);
